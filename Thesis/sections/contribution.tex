...
\todo{Beschreibung der JSON struktur, wie sie umgewandelt wird in eine hierarchy. diskussion über canvas vs svg}\\
...
\subsection{Navigieren durch den Baum}\label{sec:dynamische_aktual}
