...
var width = rightContainer.offsetWidth, height = rightContainer.offsetHeight;
...
var rightSVG = d3.select(rightContainer).append("svg")
    .attr("width", width)
    .attr("height", height);

// create group elements in the svg for links and nodes
var svgLinkGroup = rightSVG.append("g");
var svgNodeGroup = rightSVG.append("g");
